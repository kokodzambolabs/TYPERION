...
// model 100 razy prostym promptem (temp 0.7), bierze dominantę
// całego typu (home:away). Tiebreaker przy remisie dominanty:
// mediana per pole z całej puli odpowiedzi.
//
