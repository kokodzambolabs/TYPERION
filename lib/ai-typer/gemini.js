...
//
// responseMimeType: bez tego model czasem wraca z JSON-em w markdown bloku
// (```json ... ```), z grounding często czystym tekstem. Wymuszamy
// "application/json" - dostajemy gwarantowany surowy JSON. Parser i tak
// obsługuje oba przypadki dla retro-kompatybilności.
//
